...
$data = json_decode($result, true);
  ...
  if ($data != null) {
    ...
    function send_message($chat_id, $message){
        $apiToken =  "1228323573:AAEIa8wR78Y34obROvn4u5Fmf6Zv8rRP6go";
